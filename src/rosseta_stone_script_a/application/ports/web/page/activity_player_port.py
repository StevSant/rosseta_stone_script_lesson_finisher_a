...
class ActivityPlayerPagePort(ABC, LoggingMixin):
    """
    Port for the activity player container.
    Handles player controls and provides widget factory for activity interactions.

    This component is responsible for playing individual activities within a lesson.
    The hierarchy is: Course → Lesson → Activity, and this player operates at the Activity level.
    """
